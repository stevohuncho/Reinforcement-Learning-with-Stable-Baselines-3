...
class RewardShapedDQN(DQN):
    ...
    def __init__(
        ...
        reward_shaper = None,       #   New
        aux_scaling_factor = 1      #   New
    ):

        super(RewardShapedDQN, self).__init__(
            policy,
            env,
            learning_rate,
            buffer_size,
        ...
        self.aux_scaling_factor = aux_scaling_factor
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for _ in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                # Compute aux. reward
                num_points = len(replay_data.observations)
                ...
                next_actions = [None for x in range(num_points)]
